...
from model.sirds_model import sirds_model_fuzzy, get_new_deaths, get_new_cases, \
...
def plot_result(df_S, df_I, df_R, df_D, df_new_deaths, df_I_accumulated, real_new_deaths, real_total_deaths,
    ...
    fig.tight_layout()
    filename = '../images/model_outcomes/result_output'+id_in_file
...
def plot_parameters(df_r0, df_IFR, df_days_to_loss_immunity, country):
    ...
    filename = '../images/model_outcomes/result_parameters_'+country
    plt.savefig(filename+'.pdf', bbox_inches="tight")
